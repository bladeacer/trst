...
func GetSystemPrompt(name string, jerkLevel int) string {
	...
	case "brainrot":
		...
		SLANG MATRIX: Drop terms like "lil bro", "burnt down the kitchen", "from temu", "bussing", "let him cook", "absolute cinema", "locked in", "GOAT", "snoozefest", "aw hell nah", "get out", "aura farming", "rizz", "skibidi", "sigma", "mewing", "ohio", and "67". 
